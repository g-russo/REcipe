...
class SupabaseCacheService {
  ...
  /**
   * Get recipes from cache (Try Something New)
   * DEPRECATED - Use SimpleTrySomethingNew service instead
   */
  async getRecipesFromImageCache(count = 10) {
    console.warn('⚠️ getRecipesFromImageCache is deprecated. Use SimpleTrySomethingNew service instead.');
    return [];
  }
