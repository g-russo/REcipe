    ...
    if (loading && !timeoutTriggered) {
      timeoutId = setTimeout(async () => {
        ...
        try {
          ...
          setTimeout(() => setTimeoutTriggered(false), 100);
        } catch {
          router.replace('/');
        }
      }, 5000);
    }
    if (!loading && timeoutId) clearTimeout(timeoutId);
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.timeoutHintText}>Checking your session... (timeout in 5 seconds)</Text>
        </View>
      </SafeAreaView>
    );
  }
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.timeoutHintText}>Checking session and redirecting...</Text>
        </View>
      </SafeAreaView>
    );
  }
...
const styles = StyleSheet.create({
  ...
  timeoutHintText: { fontSize: 14, color: '#999', marginTop: 10, textAlign: 'center', fontStyle: 'italic' },
  header: {
  ...
  userNameText: { fontSize: 20, fontWeight: 'bold', color: '#333', marginTop: 2 },
  signOutButton: { paddingHorizontal: 15, paddingVertical: 8, backgroundColor: '#ff6b6b', borderRadius: 20 },
  signOutText: { color: '#fff', fontSize: 14, fontWeight: '600' },
  scrollView: { flex: 1 },
  titleContainer: { alignItems: 'center', paddingVertical: 30, paddingHorizontal: 20 },
  appTitle: { fontSize: 36, fontWeight: 'bold', color: '#2c3e50', letterSpacing: 1 },
  statsContainer: { flexDirection: 'row', justifyContent: 'space-around', paddingHorizontal: 20, marginBottom: 30 },
  statCard: {
    backgroundColor: '#fff', padding: 20, borderRadius: 15, alignItems: 'center', flex: 1, marginHorizontal: 5,
  ...
  sectionTitle: { fontSize: 22, fontWeight: 'bold', color: '#2c3e50', marginBottom: 15 },
  menuItem: {
    backgroundColor: '#fff', paddingVertical: 15, paddingHorizontal: 20, marginBottom: 10, borderRadius: 12,
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 2, elevation: 2,
  },
  menuItemContent: { flex: 1 },
  menuItemTitle: { fontSize: 16, fontWeight: '600', color: '#2c3e50' },
  menuItemSubtitle: { fontSize: 14, color: '#7f8c8d', marginTop: 2 },
  menuItemArrow: { fontSize: 24, color: '#bdc3c7', fontWeight: '300' },
  footer: { alignItems: 'center', paddingVertical: 30, paddingHorizontal: 20, marginTop: 20 },
  footerText: { fontSize: 14, color: '#95a5a6', fontWeight: '600' },
